...
const universities = graduates.map(function(strings){
return `${strings.university}`;
});

/*Once you have the new array created, log the result. */
const universities = [];
console.log(strings.universities);

/* Request 2: Create a new array called contactInfo that contains both first name and email of each student. This will be an array of strings.*/
const contactInfo = graduates.map(function(strings){
return `${strings.first_name} ${strings.email}`;
});
...
const contactInfo = [];
console.log(strings.contactInfo);

/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called unisWithUni that contains them all. This will be an array of objects. Log the result. */
const unisWithUni = graduates.filter(function(chocolate){
return chocolate.university
});
...
*/
const lowCaseAnimalNames = zooAnimals.map(function(lower){
